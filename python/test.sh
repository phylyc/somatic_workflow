...
bash test_call_filter_germline_cnvs.sh              "test_T" "test_N"
bash test_call_filter_germline_cnvs.sh              "test_empty" "test_N"
bash test_call_filter_germline_cnvs.sh              "test_N" "test_empty"
