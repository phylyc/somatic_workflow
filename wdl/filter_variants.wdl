...
task FilterVariantCalls {
    ...
    command <<<
        ...
        if [ "~{vcf_is_gzipped}" = "true" ]; then
            ...
            # Edit FILTER column on the plain VCF
            ...
            # Edit FILTER column directly on the plain VCF
            ...
            rm -f "~{dollar}{OUT_VCF}.idx"  # Remove the idx file generated by VariantFiltration
        fi
