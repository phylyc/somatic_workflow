...
workflow DefineWorkflowArguments {
    input {
        ...
        String script_acs_conversion =                  "https://github.com/phylyc/somatic_workflow/raw/v2.0.0/python/acs_conversion.py"
        String script_calculate_cancer_cell_fraction =  "https://github.com/phylyc/somatic_workflow/raw/v2.0.0/python/calculate_cancer_cell_fraction.py"
        String script_genotype_variants =               "https://github.com/phylyc/somatic_workflow/raw/v2.0.0/python/genotype.py"
        String script_harmonize_copy_ratios =           "https://github.com/phylyc/somatic_workflow/raw/v2.0.0/python/harmonize_copy_ratios.py"
        String script_map_to_absolute_copy_number =     "https://github.com/phylyc/somatic_workflow/raw/v2.0.0/python/map_to_absolute_copy_number.py"
        String script_merge_pileups =                   "https://github.com/phylyc/somatic_workflow/raw/v2.0.0/python/merge_pileups.py"
        String script_pileup_to_allelic_counts =        "https://github.com/phylyc/somatic_workflow/raw/v2.0.0/python/pileup_to_allelic_counts.py"
        String script_validate_inputs =                 "https://github.com/phylyc/somatic_workflow/raw/v2.0.0/python/validate_inputs.py"
