...
workflow MergePatients {
    ...
    Patient pat = object {
        ...
        ancestry_pred: if defined(other.ancestry_pred) then other.ancestry_pred else patient.ancestry_pred,
        ancestry_prob: if defined(other.ancestry_prob) then other.ancestry_prob else patient.ancestry_prob,
        ancestry_background_pca_table: if defined(other.ancestry_background_pca_table) then other.ancestry_background_pca_table else patient.ancestry_background_pca_table,
        ancestry_pca_plot: if defined(other.ancestry_pca_plot) then other.ancestry_pca_plot else patient.ancestry_pca_plot,
