...
workflow UpdateShards {
    ...
    Patient updated_patient_obj = object {
        ...
        ancestry_pred: patient.ancestry_pred,
        ancestry_prob: patient.ancestry_prob,
        ancestry_background_pca_table: patient.ancestry_background_pca_table,
        ancestry_pca_plot: patient.ancestry_pca_plot,
