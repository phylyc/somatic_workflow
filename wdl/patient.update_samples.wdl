...
workflow UpdateSamples {
    ...
    Array[Sample] samples_2 = select_first([UpdateDenoisedCopyRatio.updated_sample, samples_1])
    ...
    Array[Sample] samples_3 = select_first([UpdateStandardizedCopyRatio.updated_sample, samples_2])
    ...
    Array[Sample] samples_4 = select_first([UpdateSnpArrayPileup.updated_sample, samples_3])
